...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/js/swiper/package/js/swiper.min.css">
...
<!--  <h1><a href="<?php echo home_url(); ?>"><?php bloginfo( 'name' ); ?></a></h1>
 ...
 -->
  ...
  <form  class="navbar-header1" method="get" action="<?php bloginfo('url');?>" style="margin: 20px; "  >
